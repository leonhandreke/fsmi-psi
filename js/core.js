...
function ReplyItem(url, threading, guid, subject)
{
	...
	{
		var L_ReplyLimitMsg_Text="Auf diesen Thread kann nicht geantwortet werden. Die Antwortgrenze wurde erreicht.";
...
{
	var L_NoWSSClient_Text="Das Exportieren einer Liste erfordert eine Windows SharePoint Services-kompatible Anwendung und Microsoft Internet Explorer 6.0 oder höher.";
	var L_ExportDBFail_Text="Fehler beim Exportieren in die Datenbank. Zum Exportieren in eine Liste ist eine mit Windows SharePoint Services kompatible Anwendung erforderlich.";
...
{
	var L_ExportListSpreadsheet_Text="Sie benötigen eine Windows SharePoint Services-kompatible Anwendung, um eine Liste zu exportieren.";
...
function ExportDiagram(weburl,listguid, listid, listname, viewname, viewguid)
{
	...
	{
		var L_DiagramLaunchFail_Text="Das Diagramm konnte nicht erstellt werden.";
...
var L_EditInGrid_Text="Die Liste kann aus mindestens einem der folgenden Gründe nicht in der Datenblattansicht angezeigt werden: \n\n- Es ist kein zu Windows SharePoint Services kompatibles Datenblatt-Steuerelement installiert. \n- Ihr Webbrowser unterstützt keine ActiveX-Steuerelemente. \n- Die Unterstützung von ActiveX-Steuerelementen ist deaktiviert.";
...
var L_NoQuestion_Text="Die Umfrage enthält keine Fragen.";
var L_NoVoteAllowed_Text="Sie dürfen keine erneute Antwort zu dieser Umfrage abgeben.";
...
function SubmitSearchForView(ViewGuid)
{
	...
	if (""==searchText)
	{
		var L_Enter_Text="Bitte geben Sie mindestens einen Suchbegriff ein.";
		alert(L_Enter_Text);
...
var fNewDoc2=false;
var fNewDoc3=false;
var L_EditDocumentProgIDError_Text="'Dokument bearbeiten' erfordert eine Windows SharePoint Services-kompatible Anwendung und Microsoft Internet Explorer 6.0 oder höher.";
var L_EditDocumentRuntimeError_Text="Das Dokument konnte nicht zum Bearbeiten geöffnet werden. Es konnte keine Windows SharePoint Services-kompatible Anwendung zum Bearbeiten des Dokuments gefunden werden.";
...
var L_OpenDocumentLocalError_Text="Dieses Dokument wurde offline bearbeitet, es wurde jedoch keine Anwendung zum Öffnen des Dokuments über SharePoint konfiguriert. Das Dokument kann nur zum Lesen geöffnet werden.";
...
var L_RelativeUrlError_Text="Adressen, die von der aktuellen Seite starten, werden möglicherweise nicht richtig angezeigt. Sie müssen die vollständige URL oder eine Adresse eingeben, die vom aktuellen Server startet.";
var L_UnknownProtocolUrlError_Text="Hyperlinks müssen mit http://, https://, mailto:, news:, ftp://, file:// oder \\\\ beginnen. Überprüfen Sie die Adresse, und versuchen Sie es erneut.";
var L_UrlTooLongError_Text="Die URL für den Speicherort darf ohne die Abfrageparameter maximal 256 Zeichen enthalten. Die Abfrageparameter beginnen beim Fragezeichen (\'?\')."
...
{
	var L_DeletePartialResponse1_text="Eine unvollständige Umfrageantwort wurde gespeichert. Klicken Sie auf \'OK\', um die unvollständige Umfrageantwort zu löschen. Klicken Sie auf \'Abbrechen\', um diese Umfrage später fortzusetzen. Die unvollständige Umfrageantwort befindet sich in der Umfrageansicht \'Alle Antworten\'.\n\nMöchten Sie diese unvollständige Umfrageantwort in den Papierkorb der Website verschieben?";
	var L_DeletePartialResponse2_text="Eine unvollständige Umfrageantwort wurde gespeichert. Klicken Sie auf \'OK\', um die unvollständige Umfrageantwort zu löschen. Klicken Sie auf \'Abbrechen\', um diese Umfrage später fortzusetzen. Die unvollständige Umfrageantwort befindet sich in der Umfrageansicht \'Alle Antworten\'.\n\nMöchten Sie die unvollständige Umfrageantwort löschen?";
	var message="";
	if (recycleBinEnabled==1)
...
{
	var L_Version_Restore_Confirm_Text="Sie sind dabei, die aktuelle Version durch die ausgewählte Version zu ersetzen.";
	var message=L_Version_Restore_Confirm_Text;
	return confirm(message);
}
function DeleteItemVersionConfirmation(bRecycleBinEnabled)
{
	var L_Version_Delete_Confirm_Text="Möchten Sie diese Version wirklich löschen?";
	var L_Version_Recycle_Confirm_Text="Möchten Sie diese Version wirklich in den Papierkorb der Website verschieben?";
...
{
	var L_User_Delete_Confirm_Text="Sie sind dabei, diesen Benutzer zu löschen.";
...
{
	var L_IE5upRequired_Text="'Diskutieren' erfordert eine Windows SharePoint Services-kompatible Anwendung und Microsoft Internet Explorer 6.0 oder höher.";
	if (browseris.ie5up && browseris.win32)
...
var L_Edit_Text="Bearbeiten";
var L_ViewItem_Text="Element anzeigen";
var L_EditItem_Text="Element bearbeiten";
var L_EditSeriesItem_Text="Serie bearbeiten";
var L_DeleteItem_Text="Element löschen";
var L_DeleteDocItem_Text="Löschen";
var L_ViewProperties_Text="Eigenschaften anzeigen";
var L_EditProperties_Text="Eigenschaften bearbeiten";
var L_ViewResponse_Text="Antwort anzeigen";
var L_EditResponse_Text="Antwort bearbeiten";
var L_DeleteResponse_Text="Antwort löschen";
var L_Subscribe_Text="Benachrichtigen";
var L_CustomizeNewButton_Text="Reihenfolge der neuen Schaltflächen ändern";
var L_Review_Text="Zur Durchsicht versenden";
var L_EditIn_Text="In ^1 bearbeiten";
var L_EditInApplication_Text="Dokument bearbeiten"
var L_Checkin_Text="Einchecken";
var L_Checkout_Text="Auschecken";
var L_DiscardCheckou_Text="Auschecken verwerfen";
var L_CreateDWS_Text="Dokumentarbeitsbereich erstellen";
var L_PublishBack_Text="Am Quellort veröffentlichen";
var L_Versions_Text="Versionsverlauf";
var L_WorkOffline_Text="Verbindung mit Client herstellen";
var L_Reply_Text="Antworten";
var L_ExportContact_Text="Kontakt exportieren";
var L_ExportEvent_Text="Ereignis exportieren";
var L_Reschedule_Text="Umplanungsoptionen";
var L_Move_Text="Verschieben";
var L_Keep_Text="Beibehalten";
var L_Delete_Text="Löschen";
var L_Open_Text="Öffnen";
var L_SiteSettings_Text="Websiteeinstellungen ändern";
var L_ManageUsers_Text="Benutzer verwalten";
var L_DeleteSite_Text="Website löschen";
var L_SiteStorage_Text="Websitespeicher verwalten";
var L_MngPerms_Text="Berechtigungen verwalten";
var L_Settings_Text="Einstellungen";
var L_Remove_Text="Aus dieser Liste entfernen";
var L_ModerateItem_Text="Genehmigen/ablehnen";
var L_PublishItem_Text="Hauptversion veröffentlichen";
var L_CancelPublish_Text="Genehmigung abbrechen";
var L_UnPublishItem_Text="Veröffentlichung dieser Version aufheben";
var L_DownloadOriginal_Text="Bild herunterladen";
var L_EditVersion_Text="Bearbeiten";
var L_EditInOIS_Text="Bild bearbeiten";
var L_Workflows_Text="Workflows";
var L_Send_Text="Senden an";
var L_ExistingCopies_Text="Vorhandene Kopien";
var L_OtherLocation_Text="Anderer Speicherort";
var L_GoToSourceItem_Text="Gehe zum Quellelement";
var L_NotifyThisIsCopy_Text="Dieses Element wurde von einem anderen Speicherort kopiert und erhält aus dieser Quelle möglicherweise Aktualisierungen. Sie sollten sicherstellen, dass diese Quelle keine Aktualisierungen mehr sendet, da dieses Element andernfalls erneut erstellt wird.\n\n";
var L_SendToEmail_Text="Link als E-Mail versenden";
var L_DownloadACopy_Text="Kopie herunterladen";
var L_DocTran_Text="Dokument konvertieren";
var L_AddToMyLinks_Text="Meinen Hyperlinks hinzufügen";
var L_AddToCategory_Text="Dem Portalbereich hinzufügen";
var L_VS_DownArrow_Text="Wählen Sie eine Ansicht aus";
var L_ModifyView="Ansicht ändern";
var L_CreateView="Neue Ansicht erstellen";
...
var L_UndoCheckoutWarning_Text="Wenn Sie das Auschecken verwerfen, gehen alle Änderungen verloren, die am Dokument vorgenommen wurden. Möchten Sie das Auschecken wirklich verwerfen?";
var L_UnPublishWarning_Text=" Möchten Sie die Veröffentlichung dieser Dokumentversion wirklich aufheben?";
var L_CancleApproval_TEXT=" Möchten Sie die Genehmigung dieses Dokuments wirklich abbrechen?";
...
var L_EmptySlideShow_Text="In der Bibliothek wurden keine Bilder gefunden. Bitte fügen Sie Bilder hinzu, und versuchen Sie es dann erneut.";
var L_NotOurView_Text="Dieser Vorgang kann in der aktuellen Ansicht nicht beendet werden. Bitte wählen Sie eine andere Ansicht aus, und versuchen Sie es dann erneut.";
...
function MtgToggleTimeZone()
{
	...
	var L_ShowTZ_Text="Zeitzone anzeigen";
	var L_HideTZ_Text="Zeitzone ausblenden";
...
{
	var L_MtgKeepConfirm_Text="Die Informationen zu diesem Besprechungsdatum entsprechen nicht den Informationen in Ihrem Kalender- und Planungsprogramm. Wenn Sie dieses Besprechungsdatum beibehalten, wird es weiterhin in der Besprechungsserienliste des Arbeitsraums angezeigt.";
...
{
	var L_MtgDeleteConfirm_Text="Dieses Besprechungsdatum und der mit ihm verknüpfte Inhalt werden aus dem Arbeitsbereich gelöscht.";
...
{
	var L_DeleteGlobalConfirm_Text="Diese Seite wird aus allen Besprechungen, die mit diesem Arbeitsbereich verbunden sind, gelöscht.  ";
	var L_DeleteConfirm_Text="Möchten Sie diese Seite wirklich löschen?";
	var text;
...
var L_NotSortable_Text="Dieser Spaltentyp kann nicht sortiert werden.";
var L_NotFilterable_Text="Dieser Spaltentyp kann nicht gefiltert werden.";
var L_AOnTop_Text="A-Z";
var L_ZOnTop_Text="Z-A";
var L_SmallestOnTop_Text="Klein zu groß";
var L_LargestOnTop_Text="Groß zu klein";
var L_OldestOnTop_Text="Alt nach neu";
var L_NewestOnTop_Text="Neu nach alt";
var L_AttachmentsOnTop_Text="Anlagen zuerst";
var L_BlanksOnTop_Text="Leerzeichen zuerst";
var L_Ascending_Text="Aufsteigend";
var L_Descending_Text="Absteigend";
var L_DontFilterBy_Text="Filter aus ^1 löschen";
var L_Loading_Text="Ladevorgang wird durchgeführt...";
var L_FilterMode_Text="Filterauswahl einblenden";
var L_OpenMenu_Text="Menü öffnen";
...
function PickerDialogShowWait(ctx)
{
	...
	if (resultControl !=null)
	{
		...
		if(nav4)
			...
			parent=resultControl.parentElement;
		var L_GearToolTip_TEXT="Abfrage wird ausgeführt. Bitte warten...";
		var L_PleaseWait_TEXT="Bitte warten Sie, während Ihre Abfrage ausgeführt wird.";
...
{
	var L_ResetPagePersonalizationDialog_TXT="Sie sind dabei, alle personalisierten Webparts auf ihre globalen Werte zurückzusetzen und alle privaten Webparts zu löschen. Klicken Sie auf \'OK\', um diesen Vorgang abzuschließen. Klicken Sie auf \'Abbrechen\', um Ihre personalisierten Webparteinstellungen und privaten Webparts beizubehalten.";
	var L_ResetPartPersonalizationDialog_TXT="Zurücksetzen dieses Webparts führt zum Verlust aller Änderungen, die Sie durchgeführt haben. Möchten Sie diesen Vorgang wirklich ausführen? Klicken Sie auf \'OK\', um dieses Webpart zurückzusetzen. Klicken Sie auf \'Abbrechen\', um Ihre Änderungen beizubehalten.";
	var L_RemoveConnection_TXT="Möchten Sie die Verbindung zwischen dem Webpart \'%0\' und dem Webpart \'%1\' wirklich entfernen? Klicken Sie auf \'OK\', um die Verbindung zu entfernen. Klicken Sie auf \'Abbrechen\', um die Verbindung beizubehalten.";
	var L_ExportPersonalization_TXT="Diese Webpartseite wurde personalisiert. Daher kann mindestens eine Webparteigenschaft vertrauliche Informationen enthalten. Stellen Sie sicher, dass die Eigenschaften nur solche Informationen enthalten, die andere lesen dürfen. Zeigen Sie nach dem Exportieren dieses Webparts die Eigenschaften in der Webpartbeschreibungsdatei (WEBPART oder DWP) an, indem Sie sie in einem Text-Editor, z. B. in Microsoft Editor, öffnen.";
	var L_GetPropertiesFailure_ERR="Zurzeit können keine Eigenschaften abgerufen werden.";
	var L_SaveDirtyParts_TXT="Der Inhalt von mindestens einem Webpart auf dieser Seite wurde geändert. Klicken Sie auf \'OK\', um die Änderungen beizubehalten. Klicken Sie auf \'Abbrechen\', um die Änderungen zu verwerfen.";
	var L_ToolPaneWidenToolTip_TXT="Verbreitern";
	var L_ToolPaneShrinkToolTip_TXT="Verengen";
	var L_ToolPartExpandToolTip_TXT="Toolpart erweitern: %0";
	var L_ToolPartCollapseToolTip_TXT="Toolpart reduzieren: %0";
	var L_WebPartBackgroundColor_TXT="Hintergrundfarbe der Webparts";
	var L_TransparentTooltip_TXT="Transparente Webpart-Hintergrundfarbe";
	var L_InvalidURLPath_ERR="Die URL ist für die %0-Eigenschaft ungültig. Bitte prüfen Sie die Rechtschreibung und den Pfad der URL, und versuchen Sie es dann erneut.";
	var L_InvalidFolderPath_ERR="Der Pfad zum Ordner ist für die %0-Eigenschaft ungültig. Bitte prüfen Sie den Namen des Pfads, und versuchen Sie es dann erneut.";
	var L_InvalidFilePath_ERR="Der Pfad zur Datei oder zum Ordner ist ungültig. Bitte prüfen Sie den Namen des Pfads, und versuchen Sie es dann erneut.";
	var L_FileOrFolderUnsupported_ERR="Der aktuelle Browser unterstützt keine Hyperlinks zu Dateien oder Ordnern. Sie müssen Microsoft Internet Explorer 5.0 oder höher verwenden, um einen Pfad zu einer Datei oder einem Ordner anzugeben.";
	var L_Link_TXT="Link";
	var L_TransparentLiteral_TXT="Transparent";
	var L_ContentEditorSaveFailed_ERR="Ihre Änderungen können nicht gespeichert werden.";
	var L_AccessDenied_ERR="Zugriff beim Speichern der Webparteigenschaften verweigert: Entweder ist das Webpart direkt in die Seite eingebettet, oder Sie haben keine ausreichenden Berechtigungen, um Eigenschaften zu speichern.";
	var L_NoInitArgs_ERR="Diese Verbindung kann nicht erstellt oder geändert werden. Eines der Webparts hat keine Datenfelder.";
	var s=new Object();
...
var L_NewFormLibTb5_Text="Wählen Sie das bzw. die neu zu verknüpfenden Dokumente aus, und klicken Sie dann auf der Symbolleiste auf 'Ausgewählte Dokumente erneut verknüpfen'.";
var L_NewFormLibTb6_Text="Es können nur 500 Dokumente auf einmal neu verknüpft werden. Ändern Sie Ihre Auswahl, und versuchen Sie es dann erneut.";
...
var L_ViewVersion_Text="Anzeigen";
var L_RestoreVersion_Text="Wiederherstellen";
var L_DeleteVersion_Text="Löschen";
var L_DenyVersion_Text="Diese Version ablehnen";
var L_UnPublishVersion_Text="Veröffentlichung dieser Version aufheben";
...
var L_Version_Restore_Confirm_Text="Sie sind dabei, die aktuelle Version durch die ausgewählte Version zu ersetzen.";
var L_Version_RestoreVersioningOff_Confirm_Text="Die Versionsverwaltung ist zurzeit deaktiviert. Aus diesem Grund sind Sie dabei, die aktuelle Version zu überschreiben. Alle Änderungen dieser Version gehen verloren.";
var L_Version_NoRestore_Current_ERR="Die aktuelle Version kann nicht wiederhergestellt werden.";
...
var L_Version_NoOffline_NonCurrent_ERR="Sie können nur die aktuelle veröffentlichte oder genehmigte Version offline schalten.";
var L_Version_unpublish_Confirm_Text="Möchten Sie die Veröffentlichung dieser Dokumentversion wirklich aufheben?";
var L_Version_deny_Confirm_Text="Möchten Sie diese Version des Dokuments wirklich verweigern?";
...
var L_Version_Delete_Confirm_Text="Möchten Sie diese Version wirklich löschen?";
var L_Version_Recycle_Confirm_Text="Möchten Sie diese Version wirklich in den Papierkorb der Website verschieben?";
var L_Version_NoDelete_Current_ERR="Sie können die aktuelle eingecheckte Version, Hauptversion oder genehmigte Version nicht löschen.";
...
var L_Version_DeleteAll_Confirm_Text="Möchten Sie alle vorherigen, dieser Datei zugeordneten Nebenversionen wirklich löschen?";
var L_Version_RecycleAll_Confirm_Text="Möchten Sie alle vorherigen, dieser Datei zugeordneten Versionen wirklich in den Papierkorb der Website verschieben?";
var L_Version_DeleteAllMinor_Confirm_Text="Möchten Sie alle vorherigen Entwurfsversionen dieser Datei wirklich löschen?";
var L_Version_RecycleAllMinor_Confirm_Text="Möchten Sie alle vorherigen Entwurfsversionen dieser Datei wirklich in den Papierkorb der Website verschieben?";
var L_Version_NoDeleteAll_None_ERR="Es sind keine vorhergehenden Versionen zum Löschen vorhanden.";
